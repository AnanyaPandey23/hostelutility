  ...
  const handleChange = async (e, token) => {
    ...
    try {
      ...
      const responseUpd = await axios.post(
        "https://hostelutility-backend.vercel.app/user/updateissue",
        JSON.stringify({
          token: token,
      ...
      const responseDep = await axios.post(
        "https://hostelutility-backend.vercel.app/user/getissue",
      ...
      if (checked) {
        ...
        const response = await axios.post(
          ...
          JSON.stringify({
            to: [mail,"priyanksaxena@bitmesra.ac.in","hostel2@bitmesra.ac.in","vpsrathore2002@gmail.com"],
